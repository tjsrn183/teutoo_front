  ...
  return (
    <div className="flex-1 text-center mx-4 my-9 ">
      ...
      <button className=" relative w-full h-[48px] flex">
        <Link
          href={`https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=${process.env.NEXT_PUBLIC_KAKAO_CLIENT_ID}&redirect_uri=https://www.teutoo.site/login/kakao`}
        >
          <Image
            src={kakao_large}
            alt="kakao"
